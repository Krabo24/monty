 ...
 * Description: result stored in second value node from top and
...
/**
 * monty_sub - subtracts second value from top stack_t linked list by top value
 * @stack: pointer to top mode node of stack_t linked list
 * @line_number: current working line number of Monty bytecodes file
...
/**
 * monty_mul - multiply second value from top of stack_t linked list by
 * by top value
 * @stack: pointer to top mode node of stack_t linked list
 * @line_number: current working line number of Monty bytecodes file
 * Description: result stored in second value node from top
